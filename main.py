...
def check_output_exists(step_name):
    ...
    # 重新导入以刷新路径
    from config import GROUND_TRUTH_DB_PATH, PROCESSED_DATA_DIR, TFRECORD_DIR, TASK_TYPE
...
def run_step(script_path, step_name):
    ...
    # 自动跳过功能 (由 check_output_exists 自动处理)
...
def main():
    ...
    # 导入 TASK_TYPE 以打印当前任务
    from config import TASK_TYPE
    print(f"--- Running workflow for TASK_TYPE: '{TASK_TYPE}' ---")
